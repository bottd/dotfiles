...
return {"nvim-telescope/telescope.nvim", dependencies = {"debugloop/telescope-undo.nvim", {"nvim-telescope/telescope-fzf-native.nvim", build = "make"}}, config = _1_, keys = {{"<leader>fb", ":Telescope buffers<Cr>", mode = "n", desc = "Find Buffer"}, {"<leader>ff", ":Telescope find_files<Cr>", mode = "n", desc = "Find Files"}, {"<leader>fs", ":Telescope live_grep<Cr>", mode = "n", desc = "Find String"}, {"<leader>fk", ":Telescope keymaps<Cr>", mode = "n", desc = "Find Keymap"}, {"<leader>fh", ":Telescope help_tags<Cr>", mode = "n", desc = "Find Help"}, {"<leader>fu", ":Telescope undo<Cr>", mode = "n", desc = "Undo Tree"}}}
