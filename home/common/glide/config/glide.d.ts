...
declare const GLIDE_EXCOMMANDS: [
  ...
  },
  {
    ...
    readonly args_schema: {
      readonly location: {
        readonly type: {
          readonly enum: readonly ["home", "profile", "cwd"];
        };
  ...
  },
  {
    ...
    readonly args_schema: {
      ...
      readonly "--automove": {
        readonly type: {
          readonly enum: readonly ["left", "endline"];
        };
        readonly required: false;
      };
      readonly "--operator": {
        readonly type: {
          readonly enum: readonly ["d", "c", "r"];
        };
        readonly required: false;
  ...
  },
  {
    ...
    readonly args_schema: {
      readonly direction: {
        readonly type: {
          readonly enum: readonly ["left", "right", "up", "down", "endline"];
        };
        readonly required: true;
        readonly position: 0;
      };
  ...
  },
  {
    ...
    readonly args_schema: {
      ...
      readonly "--action": {
        readonly type: {
          readonly enum: readonly ["click", "newtab-click"];
        };
        readonly required: false;
      };
      readonly "--location": {
        readonly type: {
          readonly enum: readonly ["content", "browser-ui"];
        };
        readonly required: false;
      };
    };
...
declare global {
  ...
  type GlideKeyboardLayout = Partial<
    Record<keyof GlideKeyCodes, [key: string, shifted: string]>
  >;
  /**
 ...
 */
export type NonReadonly<T> = Pick<
  T,
  {
...
declare global {
  ...
  namespace Browser {
    ...
    namespace ActivityLog {
       ...
       */
      interface OnExtensionActivityEvent extends Events.Event<
    ...
    namespace Proxy {
       ...
       */
      interface OnRequestEvent extends Events.Event<
        (details: OnRequestDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
    ...
    namespace Tabs {
       ...
       */
      interface OnUpdatedEvent extends Events.Event<
    ...
    namespace WebNavigation {
       ...
       */
      interface OnBeforeNavigateEvent extends Events.Event<
        (details: OnBeforeNavigateDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnCommittedEvent extends Events.Event<
        (details: OnCommittedDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnDOMContentLoadedEvent extends Events.Event<
        (details: OnDOMContentLoadedDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnCompletedEvent extends Events.Event<
        (details: OnCompletedDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnErrorOccurredEvent extends Events.Event<
        (details: OnErrorOccurredDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnCreatedNavigationTargetEvent extends Events.Event<
       ...
       */
      interface OnReferenceFragmentUpdatedEvent extends Events.Event<
       ...
       */
      interface OnHistoryStateUpdatedEvent extends Events.Event<
    ...
    namespace WebRequest {
       ...
       */
      interface OnBeforeRequestEvent extends Events.Event<
        (details: OnBeforeRequestDetailsType) => BlockingResponseOrPromiseOrVoid
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnBeforeSendHeadersEvent extends Events.Event<
        (
       ...
       */
      interface OnSendHeadersEvent extends Events.Event<
        (details: OnSendHeadersDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnHeadersReceivedEvent extends Events.Event<
        (
       ...
       */
      interface OnAuthRequiredEvent extends Events.Event<
        (details: OnAuthRequiredDetailsType) => BlockingResponseOrPromiseOrVoid
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnResponseStartedEvent extends Events.Event<
        (details: OnResponseStartedDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
       ...
       */
      interface OnBeforeRedirectEvent extends Events.Event<
        (details: OnBeforeRedirectDetailsType) => void
      > {
        /**
         * Registers an event listener <em>callback</em> to an event.
         *
