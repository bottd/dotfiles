...
setup({load = {["core.defaults"] = {}, ["core.concealer"] = {config = {}}, ["core.completion"] = {config = {engine = "nvim-cmp", name = "[Norg]"}}, ["core.dirman"] = {config = {workspaces = {[workspace] = workspace_path, Inbox = (workspace_path .. "/inbox"), Journals = (workspace_path .. "/journals"), Meta = (workspace_path .. "/meta"), Notes = (workspace_path .. "/notes"), Public = (workspace_path .. "/public"), Resources = (workspace_path .. "/resources"), Scripts = (workspace_path .. "/scripts"), Zettel = (workspace_path .. "/zettel")}, default_workspace = workspace}}, ["core.esupports.metagen"] = {config = {type = "auto", template = {{"title", _2_}, {"authors", "Drake Bott"}, {"created"}, {"updated"}, {"version"}}}}, ["core.export"] = {}, ["core.export.markdown"] = {config = {extensions = "all"}}, ["core.integrations.telescope"] = {}, ["core.integrations.nvim-cmp"] = {}, ["core.integrations.treesitter"] = {}, ["core.itero"] = {}, ["core.journal"] = {config = {journal_folder = "daily", template_name = "meta/templates/journal.norg", strategy = "flat", workspace = "Journals"}}, ["core.summary"] = {}, ["core.tangle"] = {}, ["external.context"] = {}, ["external.templates"] = {config = {templates_dir = (workspace_path .. "/meta/templates")}}, ["external.worklog"] = {config = {default_workspace_title = "External"}}}})
local function _4_()
  do
